...
const u8 iv512[64] = {  // массив 8ми битных целых чисел размером 64 
					   //  заполнен нулями в 16тиричной сс (для длины хэша 512 бит)
...
const u8 iv256[64] = {  // массив 8ми битных целых чисел размером 64 
					   //  заполнен единицами в 16тиричной сс (для длины хэша 256 бит)
...
static u8 C[18][64] = { // дмумерный массив 8ми битных целых чисел размером 12 
						 //на 64 заполнен различными числами в 16тиричной сс 
	{
		0xb1, 0x08, 0x5b, 0xda, 0x1e, 0xca, 0xda, 0xe9,
		0xeb, 0xcb, 0x2f, 0x81, 0xc0, 0x65, 0x7c, 0x1f,
		0x2f, 0x6a, 0x76, 0x43, 0x2e, 0x45, 0xd0, 0x16,
		0x71, 0x4e, 0xb8, 0x8d, 0x75, 0x85, 0xc4, 0xfc, //1
		...
		0x61, 0xd5, 0x5e, 0x0f, 0x16, 0xb5, 0x01, 0x31, //2
		...
		0x06, 0xf1, 0x5e, 0x5f, 0x52, 0x9c, 0x1f, 0x8b, //3
		...
		0xa9, 0xd7, 0x2c, 0x82, 0xed, 0x03, 0xd6, 0x75, //4
		...
		0xbf, 0xcd, 0x17, 0x47, 0x25, 0x3a, 0xf5, 0xa3, //5
		...
		0x18, 0x7f, 0x9a, 0xb4, 0x9a, 0xf0, 0x8e, 0xc6, //6
		...
		0xd3, 0x47, 0x3e, 0x33, 0x19, 0x7a, 0x93, 0xc9, //7
		...
		0x89, 0xb4, 0x44, 0x3b, 0x4d, 0xdb, 0xc4, 0x9a, //8
		...
		0x80, 0x0a, 0x44, 0x0b, 0xdb, 0xb2, 0xce, 0xb1, //9
		...
		0x1f, 0xff, 0xe1, 0x8a, 0x1b, 0x33, 0x61, 0x03, //10
		...
		0x20, 0x01, 0x80, 0x21, 0x14, 0x84, 0x66, 0x79, //11
		...
		0x5d, 0x80, 0xef, 0x9d, 0x18, 0x91, 0xcc, 0x86, //12
		...
		0xf4, 0x89, 0x2b, 0xcb, 0x92, 0x9b, 0x06, 0x90, //13
		0x69, 0xd1, 0x8d, 0x2b, 0xd1, 0xa5, 0xc4, 0x2f,
		0x36, 0xac, 0xc2, 0x35, 0x59, 0x51, 0xa8, 0xd9,
		0xa4, 0x7f, 0x0d, 0xd4, 0xbf, 0x02, 0xe7, 0x1e
	}, {
		...
		0x94, 0x4c, 0x9a, 0xd8, 0xec, 0x16, 0x5f, 0xde,
		0x3a, 0x7d, 0x3a, 0x1b, 0x25, 0x89, 0x42, 0x24,
		0x3c, 0xd9, 0x55, 0xb7, 0xe0, 0x0d, 0x09, 0x84, //14
		0x80, 0x0a, 0x44, 0x0b, 0xdb, 0xb2, 0xce, 0xb1,
		0x7b, 0x2b, 0x8a, 0x9a, 0xa6, 0x07, 0x9c, 0x54,
		0x0e, 0x38, 0xdc, 0x92, 0xcb, 0x1f, 0x2a, 0x60,
		0x72, 0x61, 0x44, 0x51, 0x83, 0x23, 0x5a, 0xdb
	}, {
		0x25, 0x62, 0x06, 0x09, 0x9d, 0xb6, 0x0e, 0xc7,
		0x91, 0x2f, 0xe5, 0x1a, 0xe0, 0x82, 0x32, 0x68,
		0xfe, 0x31, 0x46, 0xa5, 0x26, 0x16, 0x03, 0x6a,
		0x04, 0xe7, 0xfe, 0x75, 0xe2, 0xfa, 0xca, 0xe4,
		0x3a, 0x54, 0xf4, 0x53, 0x9b, 0xb2, 0xd8, 0x79, //15
		0xec, 0xf6, 0x61, 0xff, 0x54, 0x74, 0x1d, 0x75,
		0xb2, 0xc5, 0x53, 0x28, 0xe0, 0xdb, 0x26, 0x1e,
		0x49, 0xa3, 0x71, 0xe8, 0x0a, 0x93, 0x17, 0xcd
	}, {
		0xf1, 0x83, 0xb9, 0xb3, 0x26, 0x1f, 0x69, 0x9f,
		0xe9, 0x6a, 0x39, 0x58, 0xac, 0xae, 0xfb, 0xb9,
		0xb0, 0x32, 0x83, 0xf6, 0x99, 0x24, 0xc9, 0xde,
		0xe6, 0xd1, 0x70, 0xcf, 0x3d, 0x59, 0xa3, 0x31,
		0xd5, 0x17, 0xf5, 0xd6, 0x14, 0x5a, 0xde, 0x80, //16
		0x2a, 0x3b, 0x4e, 0xd2, 0x60, 0x78, 0x26, 0xff,
		0x64, 0x38, 0x42, 0xdb, 0xe3, 0xbc, 0x5c, 0x81,
		0x52, 0x11, 0xdb, 0x60, 0xf6, 0xf9, 0x5e, 0x2f
	}, {
		0xd4, 0x60, 0x82, 0x86, 0x6e, 0x82, 0xda, 0x85,
		0x94, 0x2a, 0xc5, 0x17, 0xb5, 0x65, 0xe1, 0x95,
		0x21, 0x17, 0xad, 0x19, 0xbe, 0x27, 0xbc, 0xf3,
		0xbc, 0xa1, 0x92, 0x39, 0x21, 0x59, 0x5d, 0xa0, //17
		0xd6, 0x16, 0x24, 0xf2, 0x5d, 0x78, 0x9b, 0x87,
		0x12, 0x9c, 0xc3, 0xab, 0x7c, 0x84, 0xfe, 0x68,
		0x64, 0x3e, 0xa4, 0xff, 0x6a, 0xba, 0xae, 0x38,
		0x42, 0x41, 0x3d, 0x4c, 0xb1, 0x37, 0x65, 0x24
	}, {
		0xef, 0xd7, 0x73, 0x5e, 0x7d, 0xc6, 0x57, 0x80,
		0xf3, 0x9d, 0x6b, 0xe5, 0xf6, 0x28, 0xef, 0x34,
		0x9f, 0x22, 0x42, 0x4c, 0x47, 0x12, 0xaa, 0x91, //18
		0x94, 0xde, 0xc3, 0x4d, 0x1f, 0x6c, 0x1a, 0xb2,
		0x68, 0xcb, 0x4f, 0x7e, 0xe9, 0x9f, 0x95, 0x7a,
		0xfc, 0x1b, 0x25, 0xf3, 0xb3, 0xbd, 0xea, 0x5e,
		0x66, 0x82, 0xb0, 0xcb, 0x78, 0x17, 0x8d, 0xcd,
		0xc9, 0x7c, 0xfe, 0x3a, 0xfc, 0x28, 0x52, 0xc4
	}
};
